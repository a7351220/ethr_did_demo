...
const providerConfig = {
  ...
  registry: ethers.utils.getAddress('0x03d5003bf0e79C5F5223588F347ebA39AfbC3818') // ERC1056 registry address
};
...
export async function registerDID(did: string, privateKey: string): Promise<string> {
  try {
    ...
    // 注册 DID 文档（例如设置一个初始属性）
    const tx = await ethrDid.setAttribute('did/pub/Ed25519/veriKey/base64', 'QfeDA3qVPvQWf9d4BE9tFh3Jxiz5V4XQ5Z3MiiKMXh8');
