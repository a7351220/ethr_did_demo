...
const providerConfig = {
  name: 'sepolia',
  chainId: 11155111,
  rpcUrl: `https://eth-sepolia.alchemyapi.io/v2/${process.env.NEXT_PUBLIC_ALCHEMY_API_KEY}`,
  registry: ethers.utils.getAddress('0x7e42666e1a98c6ef054dc27415f9ae7e9f5ea298') // 确保这是正确的 ERC1056 注册表合约地址
};
